...
import { HANDSHAKE_STATE, READ_STATE, MessageType, LnMessageError } from './types.js';
...
class LnMessage {
    ...
    _processPacketLength() {
        ...
        try {
            ...
            if (err instanceof LnMessageError)
                throw err;
            return false;
        }
    }
    ...
    _handleProtocolFailure(error) {
        const failure = error instanceof LnMessageError
            ? error
